...
public class TransactionServiceTest {
    ...
    void findAllTransactionByPrincipalUser() {
        ...
        User              user            = new User(1, "aaaa", "bbbb", "ggg@gggg", "111gg", 111.00, null, null);
        Transaction       transaction     = new Transaction(1, "ghgg", 111.00, new User(), new User());
        List<Transaction> transactionList = new ArrayList<>();
        transactionList.add(transaction);
    ...
    void sendMoneyExeptionTest() {
        ...
        User user  = new User(1, "aaaa", "bbbb", "ggg@gggg", "111gg", 111.00, null, null);
        User user1 = new User(2, "aaazzza", "bbbzzzb", "ggzzzg@gggg", "111zgg", 117771.00, null, null);
    ...
    void sendMoneyTest() {
        ...
        User user  = new User(1, "aaaa", "bbbb", "ggg@gggg", "111gg", 10000.00 + (10000.00 * 0.005), null, null);
        User user1 = new User(2, "aaazzza", "bbbzzzb", "ggzzzg@gggg", "111zgg", 0.00, null, null);
        when(userRepository.findUsersByEmail(user.getEmail())).thenReturn(user);
        when(userRepository.findUsersByEmail(user1.getEmail())).thenReturn(user1);
    ...
    void getBackMoneyInMyBankAccountTest() {
        ...
        User user  = new User(1, "aaaa", "bbbb", "ggg@gggg", "111gg", 10000.00 , null, null);
        when(userRepository.findUsersByEmail(user.getEmail())).thenReturn(user);
    ...
    void rechargeMyBankAccountTest() {
        BankAccount bankAccount = new BankAccount(1, "111111", "44444", new User(1, "aaaa", "bbbb", "ggg@gggg", "111gg", 0.00 , null, null));
        User user  = new User(1, "aaaa", "bbbb", "ggg@gggg", "111gg", 0.00 , bankAccount, null);
        when(userRepository.findUsersByEmail(user.getEmail())).thenReturn(user);
